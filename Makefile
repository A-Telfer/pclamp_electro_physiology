...
PROFILE = default
PROJECT_NAME = pclamp_electro_physiology_classification
...
lint:
	flake8 pclamp_electro_physiology_classification
	black --check --config pyproject.toml pclamp_electro_physiology_classification

## Format source code with black
format:
	black --config pyproject.toml pclamp_electro_physiology_classification
